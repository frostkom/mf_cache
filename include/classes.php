...
class mf_cache
{
	...
	function compress_html($in)
	{
		...
		else
		{
			if(get_site_option('setting_cache_debug') == 'yes')
			{
				$out .= "<!-- Cache Compressed: ".current_time('mysql')." -->";
			}
		}
